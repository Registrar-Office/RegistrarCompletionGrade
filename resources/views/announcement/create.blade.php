        ...
        <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-8">
            <form method="POST" action="{{ route('announcement.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="body" name="body" rows="4" placeholder="Summary..." class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-200" required></textarea>
                </div>
